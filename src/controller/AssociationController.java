...
//    private GridPane buttonGrid;
    ...
    @FXML
    private Button exploreTeams;

    @FXML
    private Button exit;

    @FXML
    private Button arrangeSeason;
...
//        exploreTeams.getStyleClass().add("label");
//        exit.getStyleClass().add("text-out");
//        arrangeSeason.getStyleClass().add("text-out");
