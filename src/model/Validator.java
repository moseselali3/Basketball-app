...
public class Validator{
    ...
    public boolean validate(String pattern, String input) { //first grab the patern, process it
        Pattern regEx = Pattern.compile(pattern);           //then use matcher() to compare the input against the pattern..
